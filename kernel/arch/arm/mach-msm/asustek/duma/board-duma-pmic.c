...
static struct pm8xxx_gpio_init pm8921_gpios[] __initdata = {
	...
	PM8921_GPIO_OUTPUT(23, 1, HIGH),	/* EN_VDD_BL */
	PM8921_GPIO_OUTPUT_BUFCONF(25, 0, LOW, CMOS), /* DISP_RESET_N */
//	PM8921_GPIO_OUTPUT_FUNC(26, 0, PM_GPIO_FUNC_2), /* Bl: Off, PWM mode */
//	PM8921_GPIO_OUTPUT_VIN(30, 1, PM_GPIO_VIN_VPH), /* SMB349 susp line */
//	PM8921_GPIO_OUTPUT_FUNC_L17(26, 1, PM_GPIO_FUNC_2), /* Bl: Off, PWM mode */
	PM8921_GPIO_OUTPUT_L17(30, 1, LOW),	/* BL_EN */
	PM8921_GPIO_OUTPUT(43, 1, HIGH),	/* EN_VDD_PNL */
...
static struct pm8xxx_gpio_init pm8921_duma_kp_gpios[] __initdata = {
	PM8921_GPIO_INPUT(35, PM_GPIO_PULL_UP_30),	/* VOL_UP */
	PM8921_GPIO_INPUT(38, PM_GPIO_PULL_UP_30),	/* VOL_DOWN */
};

static struct pm8xxx_gpio_init pm8921_duma_kp2_gpios[] __initdata = {
...
void __init apq8064_pm8xxx_gpio_mpp_init(void)
{
	int i, rc;
#ifdef CONFIG_MACH_ASUSTEK
	hw_rev hw_revision = HW_REV_INVALID;
	...
	if (machine_is_apq8064_duma()) {
		if (hw_revision == HW_REV_C) {
			apq8064_configure_gpios(pm8921_duma_kp_gpios,
					ARRAY_SIZE(pm8921_duma_kp_gpios));
		} else if ((hw_revision == HW_REV_D) ||
			(hw_revision == HW_REV_E)) {
			apq8064_configure_gpios(pm8921_duma_kp2_gpios,
					ARRAY_SIZE(pm8921_duma_kp2_gpios));
		}
	}
#endif
...
static void apq8064_pm8921_duma_pwm_init(void) {
	int ret;
	printk("%s+\n", __func__);

	bl_lpm = pwm_request(2,	"backlight");

	ret = pwm_config_in_p1us_unit(bl_lpm, PWM_PERIOD_p1USEC * BL_INIT_LEVEL / PWM_LEVEL
		, PWM_PERIOD_p1USEC);
	if (ret)
...
static struct pm8xxx_led_platform_data apq8064_pm8921_leds_pdata = {
		...
		.pwm_init = apq8064_pm8921_duma_pwm_init,
};
