...
static struct platform_device asus_fuse_info_device = {
    .name           = "asus_fuseinfo",
    .id             = -1,
};
void __init asus_add_asus_info_devices(void){
    platform_device_register(&asus_fuse_info_device);
}
...
static void __init apq8064_cdp_init(void)
{
	...
	/* FIXME: bypass apq8064_init_fb to workaround probe of msm_fb error */
	apq8064_init_fb();
	apq8064_init_gpu();
