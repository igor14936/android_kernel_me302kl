...
static struct pm8xxx_gpio_init pm8921_gpios_display_pwm[] __initdata = {
	PM8921_GPIO_OUTPUT_FUNC_L17(26, 0, PM_GPIO_FUNC_2),
};
...
void __init apq8064_pm8xxx_gpio_mpp_init(void)
{
	...
	lcd_type lcd_type = asustek_get_lcd_type();
	...
	if ((hw_revision == 0x0 || hw_revision == 0x1) && (lcd_type == 0x1 || lcd_type == 0x2))
		apq8064_configure_gpios(pm8921_gpios_display_pwm,
					ARRAY_SIZE(pm8921_gpios_display_pwm));
